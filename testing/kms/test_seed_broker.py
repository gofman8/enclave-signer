"""No AWS calls: run python -m unittest discover -s testing/kms -p test_seed_broker.py -v."""
...
SPEC = importlib.util.spec_from_file_location(
    "swap_seed_broker", Path(__file__).resolve().parents[2] / "deploy/swap-seed-broker.py"
)
...
class ConfigurationTests(unittest.TestCase):
    ...
    def test_port_cannot_diverge_from_measured_broker_endpoint(self):
